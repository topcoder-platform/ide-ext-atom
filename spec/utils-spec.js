...
describe('Utils Unit Tests', () => {
  beforeEach(() => {
    ...
    nock(/\.com/)
      ...
      .reply(200, { result: { content: { token: 'test_token' } } })
      .post(testConfig.TC.AUTHN_PATH, testData.incorrectLoginRequestBody)
      .reply(403)
      .post(testConfig.TC.CHALLENGES_API_PATH + '123456/register')
      .reply(200)
      .post(testConfig.TC.CHALLENGES_API_PATH + '123457/register')
      .reply(403, { result: { content: 'You are not registered for this challenge.' } })
  })
