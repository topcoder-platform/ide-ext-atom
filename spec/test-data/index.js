...
const newUserLoginRequestBody = _.cloneDeep(incorrectLoginRequestBody)
newUserLoginRequestBody.username = 'new'
newUserLoginRequestBody.password = 'new'
const newUserAuthZRequestBody = {
  param: {
    externalToken: 'new',
    refreshToken: 'new'
  }
}
const newUserAuthZResponse = {
  result: {
    content: {
      token: testConfig.NEW_USER_TOKEN
    }
  }
}
...
module.exports = {
  ...
  validAuthZResponse,
  newUserAuthZRequestBody,
  newUserAuthZResponse,
  newUserLoginRequestBody
}
